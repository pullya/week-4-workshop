...
var file_api_category_service_category_service_proto_goTypes = []interface{}{
	(*Category)(nil),                // 0: pullya.week_4_workshop.category_service.category_service.v1.Category
	(*GetCategoryByIdRequest)(nil),  // 1: pullya.week_4_workshop.category_service.category_service.v1.GetCategoryByIdRequest
	(*GetCategoryByIdResponse)(nil), // 2: pullya.week_4_workshop.category_service.category_service.v1.GetCategoryByIdResponse
}
var file_api_category_service_category_service_proto_depIdxs = []int32{
	0, // 0: pullya.week_4_workshop.category_service.category_service.v1.GetCategoryByIdResponse.category:type_name -> pullya.week_4_workshop.category_service.category_service.v1.Category
	1, // 1: pullya.week_4_workshop.category_service.category_service.v1.CategoryService.GetCategoryById:input_type -> pullya.week_4_workshop.category_service.category_service.v1.GetCategoryByIdRequest
	2, // 2: pullya.week_4_workshop.category_service.category_service.v1.CategoryService.GetCategoryById:output_type -> pullya.week_4_workshop.category_service.category_service.v1.GetCategoryByIdResponse
